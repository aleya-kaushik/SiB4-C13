...
!-----------------------------------------------------------------
      ...
      real(r8), parameter ::  &
       ...
       real(r8), parameter :: &
            ...
            bco2m  = 284.0,      & ! mixed layer CO2 concentration (ppm)
       ...
       real(r8), parameter :: &
           ...
           rpoolinitc3 = 0.0108432352319488, &  ! initial c3 pool allocation based on d13C=-26
                                     ! -26 = (R_spl/R_pdb -1)*1000.
                                     ! -26 = (rpoolinit/pdb-1)*1000.
           rpoolinitc4 = 0.0109917556667138   ! initial c4 pool allocation based on d13C=-12.4                 
