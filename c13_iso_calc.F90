...
lpc13 =  pool_indx_leaf_c13-npoollu/2 !ntpool index 12, npoolpft index 6
frpc13 = pool_indx_froot_c13-npoollu/2 !ntpool index 13, npoolpft index 7
crpc13 = pool_indx_croot_c13-npoollu/2 !ntpool index 14, npoolpft index 8
wpc13 =  pool_indx_stwd_c13-npoollu/2 !ntpool index 15, npoolpft index 9
ppc13 =  pool_indx_prod_c13-npoollu/2 !ntpool index 16, npoolpft index 10
  ...
  fract%rcpoolfirec13 = & 
   ...
   fract%poolemisc13 = &
     ...
     - (poollt%poolpft_dloss(lpc13,1) &
        ...
        + pooldt%poollu_dloss(strlpc13,1)) )
!else
!  poollt%rcpoolfirec13 = (fract%rcassim/(fract%rcassim+1.0D0))  
endif
